# NewLife.UnitTest - 单元测试扩展库

![GitHub top language](https://img.shields.io/github/languages/top/newlifex/NewLife.UnitTest?logo=github)
![GitHub License](https://img.shields.io/github/license/newlifex/NewLife.UnitTest?logo=github)
![Nuget Downloads](https://img.shields.io/nuget/dt/NewLife.UnitTest?logo=nuget)
![Nuget](https://img.shields.io/nuget/v/NewLife.UnitTest?logo=nuget)
![Nuget (with prereleases)](https://img.shields.io/nuget/vpre/NewLife.UnitTest?label=dev%20nuget&logo=nuget)
